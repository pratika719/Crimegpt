import { investigationProfileRepository } from "@/features/case/repositories/investigation-profile.repository";
...
export class InvestigationProfileService {
  ...
  async upsertProfile(caseId: string, userId: string, data: {
    ...
    await activityService.logInvestigationProfileUpdated(caseId, userId);
    return profile;
  }
  ...
  async addVictim(caseId: string, userId: string, data: {
    ...
    await activityService.logVictimAdded(caseId, userId, victim.person.name);
    return victim;
  }
  ...
  async updateVictim(id: string, userId: string, data: {
    ...
    await activityService.logVictimUpdated(victim.caseId, userId, victim.person.name);
    return victim;
  }
  ...
  async deleteVictim(id: string, userId: string) {
    ...
    await activityService.logVictimDeleted(victim.caseId, userId, victim.person.name);
    return victim;
  }
  ...
  async addAccused(caseId: string, userId: string, data: {
    ...
    await activityService.logAccusedAdded(caseId, userId, accused.person.name);
    return accused;
  }
  ...
  async updateAccused(id: string, userId: string, data: {
    ...
    await activityService.logAccusedUpdated(accused.caseId, userId, accused.person.name);
    return accused;
  }
  ...
  async deleteAccused(id: string, userId: string) {
    ...
    await activityService.logAccusedDeleted(accused.caseId, userId, accused.person.name);
    return accused;
  }
  ...
  async addWitness(caseId: string, userId: string, data: {
    ...
    await activityService.logWitnessAdded(caseId, userId, witness.person.name);
    return witness;
  }
  ...
  async updateWitness(id: string, userId: string, data: {
    ...
    await activityService.logWitnessUpdated(witness.caseId, userId, witness.person.name);
    return witness;
  }
  ...
  async deleteWitness(id: string, userId: string) {
    ...
    await activityService.logWitnessDeleted(witness.caseId, userId, witness.person.name);
    return witness;
  }
  ...
  async addVehicle(caseId: string, userId: string, data: {
    ...
    await activityService.logVehicleAdded(caseId, userId, vehicle.licensePlate || "Unknown");
    return vehicle;
  }
  ...
  async updateVehicle(id: string, userId: string, data: {
    ...
    await activityService.logVehicleUpdated(vehicle.caseId, userId, vehicle.licensePlate || "Unknown");
    return vehicle;
  }
  ...
  async deleteVehicle(id: string, userId: string) {
    ...
    await activityService.logVehicleDeleted(vehicle.caseId, userId, vehicle.licensePlate || "Unknown");
    return vehicle;
  }
  ...
  async addSeizedItem(caseId: string, userId: string, data: {
    ...
    await activityService.logSeizedItemAdded(caseId, userId, item.itemName);
    return item;
  }
  ...
  async updateSeizedItem(id: string, userId: string, data: {
    ...
    await activityService.logSeizedItemUpdated(item.caseId, userId, item.itemName);
    return item;
  }
  ...
  async deleteSeizedItem(id: string, userId: string) {
    ...
    await activityService.logSeizedItemDeleted(item.caseId, userId, item.itemName);
    return item;
  }
  ...
  async addMedicalInfo(caseId: string, userId: string, data: {
    ...
    await activityService.logMedicalInfoAdded(caseId, userId, info.doctorName || "Unknown");
    return info;
  }
  ...
  async updateMedicalInfo(id: string, userId: string, data: {
    ...
    await activityService.logMedicalInfoUpdated(info.caseId, userId, info.doctorName || "Unknown");
    return info;
  }
  ...
  async deleteMedicalInfo(id: string, userId: string) {
    ...
    await activityService.logMedicalInfoDeleted(info.caseId, userId, info.doctorName || "Unknown");
    return info;
  }
  ...
  async addCourtInfo(caseId: string, userId: string, data: {
    ...
    await activityService.logCourtInfoAdded(caseId, userId, info.caseNumber || "Unknown");
    return info;
  }
  ...
  async updateCourtInfo(id: string, userId: string, data: {
    ...
    await activityService.logCourtInfoUpdated(info.caseId, userId, info.caseNumber || "Unknown");
    return info;
  }
  ...
  async deleteCourtInfo(id: string, userId: string) {
    ...
    await activityService.logCourtInfoDeleted(info.caseId, userId, info.caseNumber || "Unknown");
    return info;
  }
}
