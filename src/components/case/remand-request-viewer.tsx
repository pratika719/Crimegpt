      ...
      <div className="p-6 md:p-8 space-y-8">
        ...
        <div className="rounded-lg border border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/20 p-5 space-y-3">
          ...
          <div className="grid gap-4 sm:grid-cols-3 text-xs font-mono">
            <div>
              <span className="block text-zinc-450 dark:text-zinc-550 mb-0.5">FIR NUMBER</span>
            ...
            <table className="w-full text-left border-collapse text-xs">
              ...
              <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800 text-zinc-800 dark:text-zinc-200">
                {accusedDetails.map((accused, idx) => (
                  <tr key={idx} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-850">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid gap-3">
            {groundsForRemand.map((ground, i) => (
              <div 
                key={i}
                className="rounded-lg border border-zinc-150 dark:border-zinc-850 bg-zinc-50/20 dark:bg-zinc-950/10 p-4 text-xs text-zinc-700 dark:text-zinc-300 leading-relaxed font-medium flex items-start gap-3"
              >
        ...
        <div className="space-y-4 pt-4 border-t border-zinc-200 dark:border-zinc-800">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="md:col-span-2 rounded-lg border border-zinc-150 dark:border-zinc-850 bg-zinc-50/30 dark:bg-zinc-950/20 p-4 text-xs italic text-zinc-650 dark:text-zinc-400">
              &quot;{officerRemarks}&quot;
            </div>
