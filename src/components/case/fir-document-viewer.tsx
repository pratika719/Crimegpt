      ...
      <div className="p-6 md:p-8 space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="flex items-start gap-3 rounded-lg border border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/20 p-4 transition-all hover:bg-zinc-50 dark:hover:bg-zinc-950/30">
            <Calendar className="h-5 w-5 text-zinc-400 dark:text-zinc-500 mt-0.5 flex-shrink-0" />
            <div className="space-y-1">
              <span className="block text-[10px] uppercase font-bold text-zinc-400 dark:text-zinc-500 font-mono tracking-widest">
          ...
          {/* Incident Location */}
          <div className="flex items-start gap-3 rounded-lg border border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/20 p-4 transition-all hover:bg-zinc-50 dark:hover:bg-zinc-950/30">
            <MapPin className="h-5 w-5 text-zinc-400 dark:text-zinc-500 mt-0.5 flex-shrink-0" />
            <div className="space-y-1">
              <span className="block text-[10px] uppercase font-bold text-zinc-400 dark:text-zinc-500 font-mono tracking-widest">
                Place of Occurrence
              </span>
        ...
        <div className="space-y-3 pt-2">
          <div className="flex items-center gap-2">
            <AlertOctagon className="h-4.5 w-4.5 text-zinc-400 dark:text-zinc-500" />
            <h3 className="text-xs font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest font-mono">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {fir.applicableSections.map((sec, idx) => (
              <div 
                key={idx}
                className="rounded-lg border border-zinc-150 dark:border-zinc-800/80 bg-zinc-50/20 dark:bg-zinc-950/10 p-4 space-y-2.5 transition-all hover:border-zinc-300 dark:hover:border-zinc-700"
              >
        ...
        <div className="space-y-3 pt-2">
          <div className="flex items-center gap-2">
            <Compass className="h-4.5 w-4.5 text-zinc-400 dark:text-zinc-500" />
            <h3 className="text-xs font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest font-mono">
